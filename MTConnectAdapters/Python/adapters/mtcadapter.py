...
class MTCAdapter(socketserver.TCPServer):
    ...
    def __init__(self):
        ...
        if self.device_class is None:
            raise Exception("MTCAdapter requires the attribute 'device_class' to be defined")
